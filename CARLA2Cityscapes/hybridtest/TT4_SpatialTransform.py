...
if(training_phase):
    ...
    save_model_path = "../../SIMS/trainedmodels/transform"
    mat_path = join(data_dir, 'Exp/C2C', run_str, 'PreTransform-512') + '/'
    save_result_path = join(data_dir, 'Exp/C2C', run_str, 'Transformed-512') + '/'
    label_path = join(data_dir, 'Exp/C2C', run_str, 'SegColor-512') + '/'

...
addpath('../../SIMS/matlab_code');
%path for label map
label_path = fullfile(dataDir, 'Exp/C2C', runStr, 'SegColor-256');
% original segment masks
mask_path = fullfile(dataDir, 'Exp/C2C', runStr, 'SegList-256');
...
img_size_h = 256;
img_size_w = 512;
save_path = fullfile(dataDir, 'Exp/C2C', runStr, 'PreOrder-256');
mkdir(save_path);
load('../../SIMS/matlab_code/cityscapes_colormap.mat');

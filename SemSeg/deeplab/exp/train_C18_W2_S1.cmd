...
set CITYSCAPES_DIR=%DATA_DIR%\CarlaGen\C18_W2_S1
set EXP_FOLDER=%DATA_DIR%\Exp\DeepLabCityscapes\C18_W2_S1
set INIT_FOLDER=%DATA_DIR%\Exp\DeepLabCityscapes\pretrained-ImageNet\model.ckpt
set TRAIN_LOGDIR=%EXP_FOLDER%\trainlog
mkdir %TRAIN_LOGDIR%

set CITYSCAPES_DATASET=%CITYSCAPES_DIR%\tfrecord-1024
